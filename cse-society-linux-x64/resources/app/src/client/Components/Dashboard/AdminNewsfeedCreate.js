...
class AdminNewsfeedCreate extends React.Component{
  ...
  handleSubmit = (data) => {
    Axios({
      ...
      headers: {
        ...
        this.props.history.push('/dashboard/newsfeed');
      }).catch((e) => {
        console.log(e)
    })
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminNewsfeedCreate);