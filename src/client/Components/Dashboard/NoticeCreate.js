...
class AdminNoticeCreate extends React.Component{
    ...
    return (
      <div id="Dashboard">
        <div className="content-wrapper">
          <Editor title="Notice" AddNew={this.handleSubmit}/>
        </div>
      </div>
    );
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminNoticeCreate);